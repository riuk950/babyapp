...
- [x] T3. Parser de entrada manual (formato y validación)
...
- [x] T4. Temperatura efectiva: promedio, redondeo half-up y fallback
...
- [x] T7. Tabla de recomendación y ajustes por franja
      RF: RF-7 · plan §2, §6
...
- [x] T8. Contratos de repository en `core/domain/contracts/`
      RF: RF-2, RF-4 · plan §2
...
- [x] T9. Adaptador Open-Meteo (HTTP + JSON) en `data/weather/`
...
- [x] T12. Configurar l10n en `main.dart`; crear ARB base para español.
      RF: §6 · plan §5(11)
      Hecho cuando: `flutter analyze` sin hallazgos y la app compila con locale
      español por defecto.

- [x] T13. Controller de la pantalla en `features/clothing/presentation/`
...
- [x] T14. Pantalla (renderiza y delega) en `features/clothing/presentation/`
...
- [x] T15. Arranque y tema de la app
