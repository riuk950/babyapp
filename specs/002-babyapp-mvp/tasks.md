...
- [ ] T5. Configurar l10n en `main.dart`; crear ARB base para español.
      RF: §6 · plan §5(8)
      Hecho cuando: `flutter analyze` sin hallazgos y la app compila con locale
      español por defecto.

- [ ] T6. Controller en `features/sleep/presentation/`
...
- [ ] T7. Pantalla (renderiza y delega) en `features/sleep/presentation/`
...
- [ ] T8. Integración en `main.dart` (home = SleepPage)
