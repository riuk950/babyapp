...
## Fase 0 — Lógica pura (`core/`)

- [ ] T1. Secciones y modelos en `core/breastmilk/`
...
- [ ] T2. Contenido 4/4 en `core/breastmilk/breastmilk_content.dart`
...
## Fase 1 — Interfaz (`features/breastmilk/`)

- [ ] T4. Controller de sesión efímera
...
- [ ] T5. Pantalla (renderiza y delega)
      RF: RF-1..RF-5 · RNF-2, RNF-5 · CL-1/3/4/8/9 · plan §2
...
- [ ] T6. Integración en `main.dart` (home = BreastMilkPage)
...
- [ ] T7. Widget test de la pantalla
      ...
      scroll, reflujo de tabla, retorno con atrás, layout ≥320 dp y etiquetas en
      español.
